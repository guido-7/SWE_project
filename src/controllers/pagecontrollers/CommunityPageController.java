...
import src.controllers.componentcontrollers.RulesController;
...
public class CommunityPageController implements Initializable, PageController {
    //nav bar
    @FXML
    ...
    public void init_data() throws SQLException {
        ...
        currentCommunity = communityService.getCommunity();
    ...
    private void openConfirmationDialog() throws IOException {
        ...
        ConfirmationDialogController confirmationDialogPageController = loader.getController();
    ...
    private void handleAddRuleClick() {
        try {
            ...
            AddRulePageController addRuleController = PageControllerFactory.createAddRuleController(communityId);
